package com.nudriin.myreadwritefile
...
import com.nudriin.myreadwritefile.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun loadData(title: String) {
        val fileModel = Helper.readFromFile(this, title)
    ...
    private fun saveFile() {
        when {
            ...
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(this, "Kontent harus diisi terlebih dahulu", Toast.LENGTH_SHORT).show()
                ...
                fileModel.data = text
                Helper.writeToFile(fileModel, this)
